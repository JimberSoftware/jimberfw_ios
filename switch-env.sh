...
case "$ENVIRONMENT" in
    staging)
        ...
        cp "$ROOT_DIR/Sources/WireGuardApp/Envs/Staging/Staging.xcconfig,.example" "$ROOT_DIR/Sources/WireGuardApp/Config.xcconfig"    
        ;;
    production)
        ...
        cp "$ROOT_DIR/Sources/WireGuardApp/Envs/Prod/Prod.xcconfig,.example" "$ROOT_DIR/Sources/WireGuardApp/Config.xcconfig"    
        ;;
    local)
        ...
        cp "$ROOT_DIR/Sources/WireGuardApp/Envs/Local/Local.xcconfig,.example" "$ROOT_DIR/Sources/WireGuardApp/Config.xcconfig"           
        ;;
    dc)
        ...
        cp "$ROOT_DIR/Sources/WireGuardApp/Envs/Dc/Dc.xcconfig,.example" "$ROOT_DIR/Sources/WireGuardApp/Config.xcconfig"    
        ;;
    ...
    beta)
        ...
        cp "$ROOT_DIR/Sources/WireGuardApp/Envs/Beta/Beta.FastLane.example" "$ROOT_DIR/WireGuard.xcodeproj/fastlane/Appfile"
        cp "$ROOT_DIR/Sources/WireGuardApp/Envs/Beta/Beta.Info.Plist.example" "$ROOT_DIR/Sources/WireGuardApp/UI/iOS/Info.plist" 
        cp "$ROOT_DIR/Sources/WireGuardApp/Envs/Beta/Beta.xcconfig,.example" "$ROOT_DIR/Sources/WireGuardApp/Config.xcconfig"        
        ;;        
esac
